...
static constexpr auto qt_meta_stringdata_ZN10PlotWidgetE = QtMocHelpers::stringData(
    "PlotWidget",
    "paramsChanged",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10PlotWidgetE[] = {
...
Q_CONSTINIT const QMetaObject PlotWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10PlotWidgetE.offsetsAndSizes,
    qt_meta_data_ZN10PlotWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10PlotWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void PlotWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (PlotWidget::*)();
            if (_q_method_type _q_method = &PlotWidget::paramsChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *PlotWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10PlotWidgetE.stringdata0))
